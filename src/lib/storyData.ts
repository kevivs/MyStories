...
export const storyScenes: StoryScene[] = [
  {
    ...
    imageSrc: '/MyStories/Arrival/A foggy night drive toward a looming gated estate, with the visual style of seed, featuring atmospheric lighting and a sense of mystery.png',
  ...
  },
  {
    ...
    imageSrc: '/MyStories/Rising/A wide shot of the garden with each lamppost emitting faint, shifting shadows, rendered in the visual style of seed, highlighting the eerie atmosphere and distorted light.png',
  ...
  },
  {
    ...
    imageSrc: "/MyStories/Climax/The lamppost's light forming a perfect square of bright intensity with swirling darkness around, maintaining the visual style of seed, emphasizing the stark contrast and ominous atmosphere.png",
  ...
  },
  {
    ...
    imageSrc: "/MyStories/Falling/A twisted, cracked statue bearing Aditya’s likeness partially forming near the path, maintaining the visual style of seed, emphasizing the eerie transformation and decaying texture.png",
  ...
  },
  {
    ...
    imageSrc: '/MyStories/Resolution/Wide shot of the garden at dawn, peaceful and beautiful again, maintaining the visual style of seed, emphasizing the serene yet unsettling calm.png',
